    ...
    def __init__(self):
        ...
        try:
            ...
            try:
                ...
                pass
            self.rounds, self.money_left, self.points, self.cp_hist = [], [], [], []
...
class MarketAgent:
    ...
    def update_cp(self, prev_auctions: Dict[str, Any]):
        ...
        if samples:
            ...
            self.cp = (1 - EMA_ALPHA) * self.cp + EMA_ALPHA * est  # EMA ... exponential moving average
